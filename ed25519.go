...
const ed25519KeyHRP string = "kse"

// Ed25519Public public key.
const Ed25519Public KeyType = "ed25519-public"

// Ed25519Key is a Ed25519 key capable of signing and encryption (converted to a X25519 key).
...
func NewEd25519KeyFromPrivateKey(privateKey *[ed25519.PrivateKeySize]byte) *Ed25519Key {
	...
	return &Ed25519Key{
		...
		publicKey: &Ed25519PublicKey{
			id:        MustID(ed25519KeyHRP, publicKeyBytes[:]),
			publicKey: &publicKeyBytes,
		},
	}
}

// X25519Key converts Ed25519Key to X25519Key.
func (k *Ed25519Key) X25519Key() *X25519Key {
...
func (s Ed25519PublicKey) X25519PublicKey() *X25519PublicKey {
